...
public class SqlRequests {
	...
	public String showSecondFieldInAllClassRoom() {
		try {
			Statement statement = connection.createStatement();
			ResultSet resultSet = statement.executeQuery( "select fio from persons order by persons.fio");
			StringBuilder table = new StringBuilder("<html>fio:<br>");
			while (resultSet.next()) {
				table.append(resultSet.getString("fio"))
						.append("<br>");
			}
			table.append("</html>");
			return table.toString();
	...
	public String showThirdFieldInAllClassRoomByLexicOrder() {
		try {
			Statement statement = connection.createStatement();
			ResultSet resultSet = statement.executeQuery(
					"select building from class_rooms order by class_rooms.building");
	...
	public String showTotalSurfaceInPerson(int responsiblePerson) {
		try {
			Statement statement = connection.createStatement();
			ResultSet resultSet = statement.executeQuery(
			...
			while (resultSet.next()) {
				table.append(resultSet.getString("sum"))
						.append("<br>");
			}
			return table.toString();
		}
